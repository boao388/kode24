  ...
  return (
    <>
      ...
      <main id="content">
        ...
        {/* board-list */}
        <article className="board-list kode-list">
          <div className="container">
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr>
                        <td>1</td>
                        <td className="title">
                          <Link href="/report/kode_view" className="hoverable">
                            <span>2025년 1월 몸캠피싱 동향 분석 보고서</span>
                          </Link>
                        </td>
                        <td>2025-01-15</td>
                        <td>
                          <img src="/assets/images/sub/ico_view_hit.png" alt="" />
                          <span>234</span>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="title">
                          <Link href="/report/kode_view" className="hoverable">
                            <span>A.I. 딥페이크 기술을 이용한 사이버 범죄 증가 분석</span>
                          </Link>
                        </td>
                        <td>2025-01-10</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="title">
                          <Link href="/report/kode_view" className="hoverable">
                            <span>텔레그램을 이용한 성착취 범죄 수법 분석</span>
                          </Link>
                        </td>
                        <td>2025-01-05</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="title">
                          <Link href="/report/kode_view" className="hoverable">
                            <span>2024년 디지털 성범죄 피해 통계 및 대응 현황</span>
                          </Link>
                        </td>
                        <td>2024-12-30</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="title">
                          <Link href="/report/kode_view" className="hoverable">
                            <span>메신저 플랫폼별 보안 취약점 분석 리포트</span>
                          </Link>
                        </td>
                        <td>2024-12-25</td>
                        <td>
